...
int trace_vfs_write(void *ctx)
{
    ...
    struct file f;
    long res = bpf_probe_read_kernel((void *)&f, sizeof(struct file), (void *)file);
    struct file_operations f_op;
    res = bpf_probe_read_kernel((void *)&f.f_op, sizeof(struct file_operations), (void *)f_op);
    __u64 f_ops_ptr = 0;
